      ...
      <div className="mx-auto px-5 sm:px-24 py-20">
        ...
        <BlurFade inView={true}>
          <div className="section-title text-center relative pb-5 mb-10">
            <h5 className="text-xl md:text-2xl font-medium text-brickred-800 uppercase mb-2">
              Contact Us
            </h5>
            <h1 className="text-2xl md:text-4xl mb-0">Get In Touch With Us</h1>
          </div>
          <div className="mx-auto max-w-2xl lg:max-w-7xl bg-gradient-to-r from-brickred-950 to-brickred-500 rounded-3xl">
              ...
              <div className="p-10 flex flex-col justify-center">
                ...
                >
                  ...
                  <div className="flex items-center gap-4 bg-white rounded-2xl px-4 py-2">
                    <MdOutlineBusinessCenter className="text-brickred-700" />
                    <input
                      type="text"
                      name="company"
                      placeholder="Company"
                  ...
                  <div className="flex items-center gap-4 bg-white rounded-2xl px-4 py-2">
                    <AiOutlineUser className="text-brickred-700" />
                    <input
                      type="text"
                      name="name"
                      placeholder="Name"
                  ...
                  <div className="flex items-center gap-4 bg-white rounded-2xl px-4 py-2">
                    <AiOutlineMail className="text-brickred-700" />
                    <input
                      type="email"
                      name="email"
                      placeholder="Email"
                  ...
                  <div className="flex items-start gap-4 bg-white rounded-2xl px-4 py-2">
                    <AiOutlineMessage className="text-brickred-700 mt-1" />
                    <textarea
                      name="message"
                      placeholder="Message"
                      className="w-full bg-transparent outline-none"
